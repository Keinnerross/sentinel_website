...
const ServicesTemplate = () => {
    ...
    return (
        <div>
            <div className="h-[80vh] md:h-screen bg-no-repeat bg-cover bg-center relative " style={{
                ...
                >
                    ...
                    <div className="w-80% md:h-full flex items-center justify-center">
                        <div className="pl-20 hidden md:flex flex-col justify-center items-center w-1/2 h-full ">
                            <h2 className="text-7xl font-bold pb-6">
                                {services[serviceId].title}
                            </h2>
                            <p>{services[serviceId].description}</p>
                        </div>
                        <div className=" md:pt-0 md:flex justify-center items-center md:w-1/2  md:h-full" >
